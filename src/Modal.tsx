...
const Modal = ({ children, setIsOpen }: { children: React.ReactNode, setIsOpen: Dispatch<SetStateAction<boolean>> }) => {
    return (
        <>
            ...
            <div className="flex flex-col fixed top-5 left-3/12 z-50 p-5 backdrop-blur-2xl items-start bg-[#161a22] \
                min-h-2/3 max-h-8/12 w-6/12 rounded-2xl shadow-2xl shadow-amber-600 inset-shadow-sm inset-shadow-indigo-500/50 \
                overflow-scroll"
            >
